import "../styles/webForgotPasswordPage5.css";
...
function WebForgotPasswordPage5() {
  return (
    <div className="page10-div">
      ...
      <div className="right-side">
        ...
        <div className="enter-div">
          <p className="enterEmail">Enter New Password</p>
        </div>
...
export default WebForgotPasswordPage5;
